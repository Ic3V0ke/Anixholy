...
const FONT_DEFAULT = "'IBM Plex Sans', 'Segoe UI', system-ui, -apple-system, sans-serif";

/** Zine: чернила + бумага + киноварь. */
const DARK_VARS: ThemeVars = {
  colorBg:           '#17151a',
  colorSurface:      '#211e26',
  colorSurfaceHover: '#29252f',
  colorBorder:       '#46404f',
  colorText:         '#f5f1e6',
  colorTextMuted:    '#8d8571',
  colorAccent:       '#e04836',
  colorAccentHover:  '#f2624f',
  fontFamily:        FONT_DEFAULT,
};

/** Zine наоборот: печать по бумаге. */
const LIGHT_VARS: ThemeVars = {
  colorBg:           '#f5f1e6',
  colorSurface:      '#fffdf6',
  colorSurfaceHover: '#efe9d8',
  colorBorder:       '#cdc5ad',
  colorText:         '#17151a',
  colorTextMuted:    '#6f695c',
  colorAccent:       '#e04836',
  colorAccentHover:  '#c93a29',
  fontFamily:        FONT_DEFAULT,
};
